    ...
    <HomeSection id="home">
      ...
      <MainContent id="home">
        <Lb id="leftBlock">
          <Topic>
            <Circle />
            <span>At your side In your cloud</span>
          </Topic>
          <Title>You do business, we do IT</Title>
          <SubText>
          ​​Ultra-secure and always-available, IT expertise delivered with the latest technology.
          </SubText>
          <CTA>
            Get in touch &nbsp;
